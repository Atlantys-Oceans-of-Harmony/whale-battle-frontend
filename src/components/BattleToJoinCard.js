      ...
      <div className=" px-3 pt-4 m-2 border-2 rounded-md">
        <div className="relative">
          <div className="absolute top-2 right-2 font-bold text-xl text-white">
            {whaleData[whaleId.toString()]?.percent}% (
            {whaleData[whaleId.toString()]?.wins}/
            {whaleData[whaleId.toString()]?.loses})
          </div>
        ...
        <div
          ...
          className="font-bold text-xl cursor-pointer text-white text-center mx-auto"
        >
          Battle #{battleId}
        </div>
